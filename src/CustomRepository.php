...
class CustomRepository extends EntityRepository
{
    ...
    */
    public function select(...$expression_args)
    {
    ...
    */
    ...
    public function selectAnd(...$expression_args)
    {
        return $this->selectAndOr("and", $expression_args);
    }

    public function selectOr(...$expression_args)
    {
    ...
    * @return array An array containing the entities that match the criteria
    */
    protected function selectAndOr($type, ...$expression_args)
    {
